...
const Todos = (props) => {
    ...
    return (
        <>
            <Addtodo />
            <button type="button" class="btn btn-secondary mx-2" onClick={handleSortByDate}>SortByDate</button>
            <button type="button" class="btn btn-secondary mx-2" onClick={handleSortByPriority}>SortByPriority</button>
